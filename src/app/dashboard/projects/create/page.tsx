...
export default function CreateProjectPage() {
  ...
  // Up to 4 additional gallery images (total max 5 images with cover)
  ...
  useEffect(() => {
    async function loadCollaborators() {
      try {
        ...
        setAvailableCollaborators(data.collaborators || []);
      } catch (err) {
  ...
  // Helper formatting for description textarea
  ...
  return (
    <div className="max-w-4xl mx-auto font-outfit">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Tambah Proyek Baru</h2>
          <p className="text-slate-500 text-sm">Isi detail proyek di bawah ini untuk menambahkannya ke portofolio Anda.</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <input
                ...
                placeholder="Misal: Website Jatim Ventura"
              />
            </div>

            {/* Deskripsi Proyek dengan Toolbar Formatting */}
            <div className="space-y-2 md:col-span-2">
              ...
              <textarea
                ...
                placeholder="Tulis penjelasan detail proyek ini. Anda bisa menggunakan **teks tebal** atau *teks miring* atau - poin daftar."
              />
            </div>
                  ...
                  <label className="flex flex-col items-center justify-center w-full md:w-auto md:px-8 h-24 border-2 border-dashed border-slate-300 rounded-xl hover:bg-slate-50 cursor-pointer transition-colors relative overflow-hidden shrink-0">
                    {uploadingCover ? (
                      ...
                      <div className="flex flex-col items-center text-slate-500">
                        ...
                        <span className="text-xs font-semibold">Pilih Foto Cover</span>
                      </div>
                    )}
                    <input 
                      type="file" 
